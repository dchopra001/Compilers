 ...
 * 
 * @author DJBrick
 * I have previous experience with regex so I opted to skip right
 * to the end instead of progressively building the regex.
 *
 */
...
public class TestWRegexSimple {
	...
	@Test
	public void testr2() {
		final String regex = "([A-Za-z]+\\s*:(\\s*[0,1])*\\s*;\\s*\\n*)*";
